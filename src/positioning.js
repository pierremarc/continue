    ...
    function (_, logger, backbone) {
        ...
        _.extend(BasePositioner.prototype, backbone.Events, {
            ...
            position: function (view) {
                ...
                if(view.positionable) {
                    ...
                    this.listenToOnce(view, 'positionable', callable);
                }
            },
        ...
        _.extend(ColumnPositioner.prototype, BasePositioner.prototype, {
            ...
            doPosition: function (view) {
                ...
                view.resetTransforms().translate(columnGroup.getXOffset(), columnGroup.getYOffset()).transition();
            },
            ...
            findColumnGroup: function (view) {
                ...
                var span = view.getSpan();
                if (!span) {
                    span = 1;
                    console.warn('No span was provided by view');
                }
                var lastPossibleColumnIndex = this.columns.length - span;
